...
import frc.robot.subsystems.drive.Drive.DrivePIDTunableNumbers;
...
public abstract class ModuleIOTalonFX extends ModuleIO {
  ...
  private final DrivePIDTunableNumbers drivePIDTunableNumbers;
  ...
  private TalonFXConfiguration getDriveConfiguration(
    ...
    driveConfig.Slot0 =
        new Slot0Configs()
            .withKP(drivePIDTunableNumbers.drivekP().get())
            .withKI(drivePIDTunableNumbers.drivekI().get())
            .withKD(drivePIDTunableNumbers.drivekD().get())
            .withKS(drivePIDTunableNumbers.drivekS().get())
            .withKV(drivePIDTunableNumbers.drivekV().get())
            .withKA(drivePIDTunableNumbers.drivekA().get());
  ...
  private TalonFXConfiguration getTurnConfiguration(
      SwerveModuleConstants<TalonFXConfiguration, TalonFXConfiguration, CANcoderConfiguration>
          constants) {
    ...
    turnConfig.Slot0 =
        new Slot0Configs()
            .withKP(drivePIDTunableNumbers.turnkP().get())
            .withKI(drivePIDTunableNumbers.turnkI().get())
            .withKD(drivePIDTunableNumbers.turnkD().get())
            .withKS(drivePIDTunableNumbers.turnkS().get())
            .withKV(drivePIDTunableNumbers.turnkV().get());
  ...
  public void setDriveVelocity(double wheelVelocityRadPerSec) {
    double motorVelocityRotPerSec =
        Units.radiansToRotations(wheelVelocityRadPerSec)
            / 0.925; // * constants.DriveMotorGearRatio;
    driveTalon.setControl(
        switch (constants.DriveMotorClosedLoopOutput) {
